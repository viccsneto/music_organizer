...
def parse_args():
    ...
    parser.add_argument("--organizing_pattern", dest="organizing_pattern", type=str, help="The pattern describing how the directories hierarchy is going to be created. (e.g., '{genre}/{bitrateclass}/') will derive something like 'Rock/GOOD_BITRATE/'", default="{genre}/{bitrateclass}/")
